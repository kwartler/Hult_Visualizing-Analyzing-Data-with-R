...
scenesDF <- read.csv('https://raw.githubusercontent.com/kwartler/Hult_Visualizing-Analyzing-Data-with-R/main/BAN1/A_Mar21/data/forceAwakens_definedScenes.csv')
