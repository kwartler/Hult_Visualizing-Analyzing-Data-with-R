...
dataPaths     <- '~/Desktop/Hult_Visualizing-Analyzing-Data-with-R/BAN1/C_Mar27/data'
templatePath  <- '~/Desktop/Hult_Visualizing-Analyzing-Data-with-R/BAN1/C_Mar27/data/hult.pptx'
