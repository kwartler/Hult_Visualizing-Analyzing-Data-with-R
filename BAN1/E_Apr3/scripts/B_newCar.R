...
cars <- cars[,!(names(cars) %in% drops)]

# Target Leakage!  The monthly payment is derived from the y variable directly!  We could have added it to the drops object but want to call it out explicitly.
