...
# Data
houses <-read.csv('https://raw.githubusercontent.com/kwartler/Hult_Visualizing-Analyzing-Data-with-R/main/DD1/E_Mar9/data/BostonHousing.csv')
...
data.frame(prediction1 = head(preds1),actual = head(trainSet$realValue))
