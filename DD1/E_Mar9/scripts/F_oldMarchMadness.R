...
# Data
bball <- read.csv('https://raw.githubusercontent.com/kwartler/Hult_Visualizing-Analyzing-Data-with-R/main/DD1/E_Mar9/data/oldNCAA.csv')
...
# This is the actual KPI Accuracy not to be confused with the forecast package function accuracy()
